...
public class Main {
    public static void main (String[] args) {
        System.out.println("Task #3. Mitchel Moore Algorithm");
        ...
        MitchelMooreRandomizer mmr = new MitchelMooreRandomizer(initialArray);
...
//        System.out.println("V = " + rc.calc(elements));
        ...
        cc.calc(elements, mmr.getModule(), 17);
    }
}
